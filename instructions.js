...
// The test should include a complete checkout process, 
    // which means users should be able to select the type of product, 
    // select the number of product, 
    // view a summary before checkout, 
    // and in the end, check out. 
